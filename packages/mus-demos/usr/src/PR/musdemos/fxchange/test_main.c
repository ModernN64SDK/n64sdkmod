...
/*************************************************************
  ...
  FXCHANGE demo main source file. This demo illustrates how to
  change the audio library FX type.

  Once executed use buttons A and B on controller one to change
  the FX type. Button A increments the FX type, button B 
  decrements the FX type.
...
int current_type=AL_FX_BIGROOM;
