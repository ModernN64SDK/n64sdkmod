...
/*************************************************************
  ...
  FXCHANGE demo music related file. This demo illustrates how 
  to change the audio library FX type.
...
extern char _wbankSegmentRomStart[];
extern char _pbankSegmentRomStart[];
extern char _pbankSegmentRomEnd[];
extern char _tune1SegmentRomStart[];
extern char _tune1SegmentRomEnd[];
