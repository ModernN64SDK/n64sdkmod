...
#define AUDIO_VVOICE_MAX         64      /* Maximum number of virtual voice. */
#define AUDIO_PVOICE_MAX         32      /* Maximum number of physical voices. */
#define AUDIO_UPDATE_MAX         64      /* Maximum numver of updates of synthesizer parameters. */
...
#define AUDIO_NUM_FIELDS       1             /* Retrace interval (1 or2). */
...
typedef struct {
  ...
  u32 state;                  /* Sequence player status. */
} Audio_seqplayer;
