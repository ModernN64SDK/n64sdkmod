 ...
 * How to make it:
 * Use imagemagick to convert a 225x225 .png to .ppm 
 * convert -set comment "IRIS image file 24 bit rgb" mips.png mips.ppm
 * ppm2cTex assumes header has "# IRIS image file 24 bit rgb" as a comment
 * Textures are converted automatically
 * Two textures are included, only one can be used at a time.
 */
...
/* Multi-tile texture of batman */
//#include "assets/batman.h"

/* Multi-tile texture of MIPS */
#include "assets/mips.h"
