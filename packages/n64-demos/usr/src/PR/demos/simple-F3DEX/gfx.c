...
#ifdef	F3DEX_GBI
# if	defined(EX)	
    t->list.t.ucode = (u64 *) gspF3DEX_fifoTextStart;
    t->list.t.ucode_data = (u64 *) gspF3DEX_fifoDataStart;
# elif	defined(LX)
    t->list.t.ucode = (u64 *) gspF3DLX_fifoTextStart;
    t->list.t.ucode_data = (u64 *) gspF3DLX_fifoDataStart;
# elif	defined(LX_Rej)
    t->list.t.ucode = (u64 *) gspF3DLX_Rej_fifoTextStart;
    t->list.t.ucode_data = (u64 *) gspF3DLX_Rej_fifoDataStart;
# elif	defined(LP_Rej)
    t->list.t.ucode = (u64 *) gspF3DLP_Rej_fifoTextStart;
    t->list.t.ucode_data = (u64 *) gspF3DLP_Rej_fifoDataStart;
# else
    error error error
# endif
#else
    t->list.t.ucode = (u64 *) gspFast3D_fifoTextStart;
    t->list.t.ucode_data = (u64 *) gspFast3D_fifoDataStart;
#endif
