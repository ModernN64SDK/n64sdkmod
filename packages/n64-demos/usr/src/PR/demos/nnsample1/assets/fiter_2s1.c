...
Gfx fiter_2_dl[] = {
  ...
  gsSPVertex(&fiter_2s1_v[42],11,0),
  ...
  gsSPVertex(&fiter_2s1_v[53],13,3),
  gsDPSetPrimColor(0,0,230,230,230,255),
  ...
  gsSPVertex(&fiter_2s1_v[66],14,0),
  gsDPSetPrimColor(0,0,255,0,0,255),
  ...
  gsSPVertex(&fiter_2s1_v[80],13,3),
  ...
  gsSPVertex(&fiter_2s1_v[93],12,0),
  gsDPSetPrimColor(0,0,230,230,230,255),
  ...
  gsSPVertex(&fiter_2s1_v[105],12,4),
  ...
  gsSPVertex(&fiter_2s1_v[117],11,0),
  ...
  gsSPVertex(&fiter_2s1_v[128],16,0),
  gsDPSetPrimColor(0,0,255,0,0,255),
  ...
  gsSPVertex(&fiter_2s1_v[144],13,0),
  ...
  gsSPVertex(&fiter_2s1_v[157],9,7),
  gsDPSetPrimColor(0,0,255,255,255,255),
  ...
  gsSPVertex(&fiter_2s1_v[166],14,0),
  ...
  gsSPVertex(&fiter_2s1_v[180],15,1),
  gsDPSetPrimColor(0,0,255,255,255,255),
  ...
  gsSPVertex(&fiter_2s1_v[195],13,0),
  ...
  gsSPVertex(&fiter_2s1_v[208],16,0),
  gsDPSetPrimColor(0,0,255,255,255,255),
  ...
  gsSPVertex(&fiter_2s1_v[224],10,0),
  ...
  gsSPVertex(&fiter_2s1_v[234],14,2),
  gsDPSetPrimColor(0,0,255,255,153,255),
  ...
  gsSPVertex(&fiter_2s1_v[248],14,0),
  gsDPSetPrimColor(0,0,153,255,255,255),
  ...
  gsSPVertex(&fiter_2s1_v[262],12,4),
  gsDPSetPrimColor(0,0,255,0,0,255),
  ...
  gsSPVertex(&fiter_2s1_v[274],16,0),
  gsDPSetPrimColor(0,0,230,230,230,255),
  ...
  gsSPVertex(&fiter_2s1_v[290],12,4),
  gsDPSetPrimColor(0,0,230,230,230,255),
  ...
  gsSPVertex(&fiter_2s1_v[302],16,0),
  ...
  gsSPVertex(&fiter_2s1_v[318],12,4),
  gsDPSetPrimColor(0,0,255,255,255,255),
  ...
  gsSPVertex(&fiter_2s1_v[330],15,0),
  ...
  gsSPVertex(&fiter_2s1_v[345],14,2),
  ...
  gsSPVertex(&fiter_2s1_v[359],14,0),
  gsDPSetPrimColor(0,0,255,255,0,255),
  ...
  gsSPVertex(&fiter_2s1_v[373],13,3),
  gsDPSetPrimColor(0,0,153,204,255,255),
  ...
  gsSPVertex(&fiter_2s1_v[386],16,0),
  ...
  gsSPVertex(&fiter_2s1_v[402],4,12),
