...
# define FONT_CODE_KA	0x55		// code "KA"(KA)
# define FONT_CODE_NA	0x64		// code "NA"(NA)
# define FONT_CODE_HA	0x69		// code "HA"(HA)
# define FONT_CODE_MA	0x6e		// code "MA"(MA)
# define FONT_CODE_GA	0x7c		// code "GA"(GA)
# define FONT_CODE_BA	0x8b		// code "BA"(BA)
# define FONT_CODE_PA	0x90		// code "PA"(PA)
#else
