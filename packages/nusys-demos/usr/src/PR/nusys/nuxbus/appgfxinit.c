...
/*======================================================================*/
/* This file has been copied from the source file, nugfxinit_ex2.c, of
	NuSystem and been slightly modified. */

/* F3DEX_GBI_2 must've been already defined. */
#ifndef F3DEX_GBI_2
#define	F3DEX_GBI_2
#endif
#include <nusys.h>
...
/*------------------------------------------------------*/    
/* This sample only utilizes the following. */
