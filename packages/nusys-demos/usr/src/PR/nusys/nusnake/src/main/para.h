...
#define PAKCHK
#define CAM_DISTANCE	2000.0	/*The distance between the camera and gaze-point */
#define SNAKE_MAX	4	/*The number of snakes */
#define SNAKE_MAX_LEN	20	/*The maximum number of heads + tails */
...
#define MOVIE_SIZE	150.0	/*The length of one side of the map object */
...
#define MOVIE_UPDATE	30	/*The updating time of movie (the V-unit) */
