/*
   ...
   The general graphic routine (the initialization and coear the frame 
   buffer) and the definition of the external veriable 
...
/*----------------------------------------------------------------------------
  ...
  Use nuGfxZBuffer (the address of the Z-buffer) and nuGfxCfb-ptr (the 
