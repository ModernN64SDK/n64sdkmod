...
/*---------------------------------------------------------------------
  Fill write buffer with random number data.  However, insert page numbers in the 
  last 4 bytes.
  ---------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------
  0 clear the whole area of read buffer
  ---------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------
  0 clear the whole area of write buffer
  ---------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------
  Write data in the whole area of 1M Flash
  ---------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------
  Compare the data of read buffer and write buffer (the whole area)
  ---------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------
  Compare the data of read buffer and write buffer (specified area)
  ---------------------------------------------------------------------*/
...
public	void	mainproc(void *arg)
{
  ...
  /* Display the version of Flash (the first one) being used */
  ...
  while(1){
    ...
    /*---------------------------------------------------------------------
      Renew Numeric Value (by C Buttons)
      ---------------------------------------------------------------------*/
    switch(cur_y) {
    case 5:
      if (trig & CONT_D)
