...
extern Gfx	setframebufs_dl[];

extern Gfx	setrend[];
extern Gfx	setrend_fog[];
extern Gfx	setrend_bilerp[];
extern Gfx	setrend_bilerp_fog[];
extern Gfx	setrend_trilerp[];
extern Gfx	setrend_trilerp_fog[];
extern Gfx	setrend_bilerp_prim[];
extern Gfx	setrend_bilerp_prim_fog[];
extern Gfx	setrend_trilerp_prim[];
extern Gfx	setrend_trilerp_prim_fog[];
extern Gfx	setrend_light[];
extern Gfx	setrend_light_fog[];
extern Gfx	setrend_light_bilerp[];
extern Gfx	setrend_light_bilerp_fog[];
extern Gfx	setrend_light_trilerp[];
extern Gfx	setrend_light_trilerp_fog[];
extern Gfx	setrend_1spec[];
extern Gfx	setrend_1spec_fog[];
extern Gfx	setrend_2spec[];
extern Gfx	setrend_2spec_fog[];
extern Gfx	linesetup_dl[];
extern Gfx	linesetup_fog_dl[];
