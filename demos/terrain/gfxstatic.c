...
/*
 *   DIFFUSE LIGHT BILERP FOG
 */
Gfx setrend_light_bilerp_fog[] = {
    gsDPPipeSync(),
...
/*
 *   DIFFUSE LIGHT TRILERP FOG
 */
Gfx setrend_light_trilerp_fog[] = {
    gsDPPipeSync(),
...
/*
 *   1 SPECULAR HIGHLIGHT FOG
 */
Gfx setrend_1spec_fog[] = {
    gsDPPipeSync(),
    ...
    gsSPSetGeometryMode(G_FOG |
			...
			G_TEXTURE_GEN),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetCombineMode(G_CC_HILITERGBDECALA, G_CC_PASS2),
...
/*
 *   2 SPECULAR HIGHLIGHTS FOG
 */
Gfx setrend_2spec_fog[] = {
    gsDPPipeSync(),
 ...
 *   Lines FOG
 */
Gfx linesetup_fog_dl[] = {
    gsDPPipeSync(),

    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_DEC_LINE2),
