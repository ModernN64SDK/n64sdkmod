...
case $choice in
   "all") dew_it spicy makemask iquesdk n64sdk u64assets n64-demos root-compatibility-enviroment rsp-tools vadpcm-tools n64graphics libkmc libhvqm libnusys n64manual n64chain-gcc;;
   "spicy") dew_it spicy;;
